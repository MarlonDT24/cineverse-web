...
-- PELÍCULAS
-- ============================================================
INSERT INTO movies (title, original_title, description, duration_minutes, genre, director, actors, release_date, rating, poster_url) VALUES
('Avatar: El Camino del Agua', 'Avatar: The Way of Water', 'Jake Sully vive con su nueva familia formada en el planeta Pandora. Cuando una amenaza familiar regresa para terminar lo que se empezó anteriormente, Jake debe trabajar con Neytiri y el ejército de la raza Navi para proteger su planeta.', 192, 'Ciencia ficción', 'James Cameron', 'Sam Worthington, Zoe Saldana, Sigourney Weaver', '2022-12-16', 7.8, 'https://image.tmdb.org/t/p/w500/m0gM9jE1KmckdXREQjqF3HhXFks.jpg'),

('Top Gun: Maverick', 'Top Gun: Maverick', 'Después de más de treinta años de servicio como uno de los mejores aviadores de la Armada, Pete "Maverick" Mitchell está donde pertenece, superando los límites como un valiente piloto de prueba y esquivando el avance en rango que lo pondría en tierra.', 130, 'Acción', 'Joseph Kosinski', 'Tom Cruise, Miles Teller, Jennifer Connelly', '2022-05-27', 8.3, 'https://image.tmdb.org/t/p/w500/62HCnUTziyWcpDaBO2i1DX17ljH.jpg'),

('Black Panther: Wakanda Forever', 'Black Panther: Wakanda Forever', 'La reina Ramonda, Shuri, MBaku, Okoye y las Dora Milaje luchan para proteger su nación de las potencias mundiales que intervienen tras la muerte del rey TChalla.', 161, 'Acción', 'Ryan Coogler', 'Letitia Wright, Angela Bassett, Tenoch Huerta', '2022-11-11', 6.7, 'https://image.tmdb.org/t/p/w500/sv1xJUazXeYqALzczSZ3O6nkH75.jpg'),

('Jurassic World: Dominion', 'Jurassic World Dominion', 'Cuatro años después de la destrucción de Isla Nublar, los dinosaurios ahora viven y cazan junto a los humanos en todo el mundo. Este frágil equilibrio remodelará el futuro y determinará, de una vez por todas, si los seres humanos deben seguir siendo los depredadores dominantes en un planeta que ahora comparten con las criaturas más temibles de la historia.', 147, 'Aventura', 'Colin Trevorrow', 'Chris Pratt, Bryce Dallas Howard, Laura Dern', '2022-06-10', 5.6, 'https://image.tmdb.org/t/p/w500/kAVRgw7GgK1CfYEJq8ME6EvRIgU.jpg'),

('Doctor Strange en el Multiverso de la Locura', 'Doctor Strange in the Multiverse of Madness', 'El Doctor Strange desata un mal innombrable al utilizar un hechizo prohibido que abre las puertas del multiverso.', 126, 'Fantasía', 'Sam Raimi', 'Benedict Cumberbatch, Elizabeth Olsen, Chiwetel Ejiofor', '2022-05-06', 6.9, 'https://image.tmdb.org/t/p/w500/1Xy1kLzM4n3N8lPweZt47K6Xy5O.jpg'),

('Spider-Man: No Way Home', 'Spider-Man: No Way Home', 'Peter Parker es desenmascarado y ya no puede separar su vida normal de ser un superhéroe. Cuando pide ayuda al Doctor Strange, las apuestas se vuelven aún más peligrosas, forzándolo a descubrir lo que realmente significa ser Spider-Man.', 148, 'Acción', 'Jon Watts', 'Tom Holland, Zendaya, Benedict Cumberbatch', '2021-12-17', 8.0, 'https://upload.wikimedia.org/wikipedia/en/0/00/Spider-Man_No_Way_Home_poster.jpg'),

('Sinners', 'Sinners', 'Tratando de dejar atrás sus problemáticas vidas, dos hermanos gemelos regresan a su ciudad natal para empezar de nuevo, solo para descubrir que un mal aún mayor los está esperando.', 137, 'Terror', 'Ryan Coogler', 'Michael B. Jordan, Hailee Steinfeld, Wunmi Mosaku', '2022-12-04', 7.5, 'https://image.tmdb.org/t/p/w500/zdClwqpYQXBSC.jpg');
